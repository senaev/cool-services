...
module.exports = class Call {
    ...
    /**
     * В случае, если вызов дочернего метода вернул ошибку, мы всё равно хотели-бы видеть полную информацию об
     * этом методе, о том, какие у него были дочерние вызовы и т.д. Ну и вернуть в том числе ошибку естественно
     */
